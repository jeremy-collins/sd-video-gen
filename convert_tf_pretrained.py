#from https://github.com/wilson1yan/VideoGPT
import sys
...
print(f'Saving state_dict as models/i3d_pretrained_{n_class}.pt')
torch.save(state_dict, f'models/i3d_pretrained_{n_class}.pt')
