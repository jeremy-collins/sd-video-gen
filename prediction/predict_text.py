...
if __name__ == "__main__":  
    ...
    if args.dataset == 'ball':
        ...
        if args.mode == 'train':
            ...
            # ***TEST***
            test_dataset = UCF101(ucf_data_dir, ucf_label_dir, frames_per_clip=16, train=False, transform=tfs, num_workers=12, frame_rate=3) # frames_between_clips/frame_rate
            # ***TEST***
